  ...
  return (
    <header className="bg-white border-b border-slate-200 shadow-sm px-4 py-2">
      <div className="grid grid-cols-12 gap-4 items-start">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="grid grid-cols-12 gap-2">
              ...
              <div className="col-span-3">
                ...
                <input type="text" value={vesselInfo.voyageNo} readOnly className="w-full text-sm bg-slate-50 border border-slate-300 rounded px-2 py-1.5 text-slate-500" />
              </div>
              <div className="col-span-3">
                 <label className="block text-[10px] text-slate-500 uppercase mb-0.5">IMO</label>
                 <input type="text" value={vesselInfo.imo} readOnly className="w-full text-sm bg-slate-50 border border-slate-300 rounded px-2 py-1.5 text-slate-500" />
              </div>
            </div>
        ...
        {/* Group 2: Shift Info (Static/Plan Info) */}
        ...
        <div className="col-span-2 flex flex-col gap-2 justify-end h-full">
          ...
          <div className="mb-1">
            ...
            <div className="bg-slate-800 text-white text-center py-1.5 rounded text-xs font-mono font-bold tracking-wide border border-slate-600 shadow-inner">
              {startTime || '--:--'} <span className="text-slate-400 mx-1">➔</span> {endTime || '--:--'}
            </div>
          </div>
          ...
          <div className="flex gap-2 mt-auto pt-1">
            <button 
              ...
              disabled={shiftState !== ShiftState.IDLE && shiftState !== ShiftState.PAUSED && shiftState !== ShiftState.COMPLETED && shiftState !== ShiftState.DISCHARGING}
