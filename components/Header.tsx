...
import {
  Ship, Play, Square, Anchor, ArrowRightLeft, Layers, Clock
} from 'lucide-react';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="bg-white border-b border-slate-200 shadow-sm">
      ...
      {/* ────────────────────────────── COMPACT BAR ────────────────────────────── */}
      <div
        className="px-4 py-2 flex items-center justify-between bg-slate-50 border-b border-slate-200 cursor-pointer hover:bg-slate-100 transition"
      ...
      >
        ...
        <div className="text-[10px] text-blue-600 font-bold select-none">
                ...
                <div className="grid grid-cols-12 gap-2 bg-blue-50 p-2 rounded border border-blue-100">
                  <div className="col-span-8 border-r border-blue-200 pr-2">
                    ...
                    <select
                      ...
                      className="w-full text-sm font-bold text-blue-800 bg-white border border-blue-300 rounded px-2 py-1.5"
                    >
                  ...
                  <div className="col-span-4 pl-1">
                    ...
                    <select
                      ...
                      className="w-full text-sm font-bold bg-white border border-slate-300 rounded px-2 py-1.5"
                    >
                      {holds.map(h => (
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input type="datetime-local" className="w-full text-sm bg-white border border-slate-300 rounded px-2 py-1.5" />
                  </div>
                  <div>
            ...
            <div className="col-span-2 flex flex-col gap-2 justify-end h-full">
              ...
              <div className="flex gap-2 mt-auto pt-1">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1 bg-blue-600 hover:bg-blue-700 text-white py-2 rounded shadow-sm font-bold text-xs uppercase"
                >
                ...
                <button
                  onClick={onEndShift}
                  className="flex-1 flex items-center justify-center gap-1 bg-red-600 hover:bg-red-700 text-white py-2 rounded shadow-sm font-bold text-xs uppercase"
                >
